                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="<?php if(isset($_SESSION['Receiver']) && $_SESSION['Receiver'] != null) echo $_SESSION['Receiver']['name']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="mobile">行動電話</label>
                                            <input type="text" class="form-control" id="mobile" name="mobile" value="<?php if(isset($_SESSION['Receiver']) && $_SESSION['Receiver'] != null) echo $_SESSION['Receiver']['mobile']; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="address" name="address" value="<?php if(isset($_SESSION['Receiver']) && $_SESSION['Receiver'] != null) echo $_SESSION['Receiver']['address']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone" value="<?php if(isset($_SESSION['Receiver']) && $_SESSION['Receiver'] != null) echo $_SESSION['Receiver']['phone']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="text" class="form-control" id="email" name="email" value="<?php if(isset($_SESSION['Receiver']) && $_SESSION['Receiver'] != null) echo $_SESSION['Receiver']['email']; ?>">
                                        </div>
                                    </div>
