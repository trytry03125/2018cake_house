...
// 新品上市
$query2 = $db->query("SELECT * FROM products ORDER BY created_at DESC LIMIT 0,10");
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <a href="contact.html">前往聯絡我們頁面</a>
 ...
 _________________________________________________________ -->
        <div id="copyright">
            <div class="container">
                ...
                <div class="col-md-6">
                    <p class="pull-right">Designed by <a href="http://www.macroviz.com">Kemie 
